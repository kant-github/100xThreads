...
export default function ({ className }: DashboardMetricsProps) {
    ...
    return (
        <div className={`${className} flex flex-row items-center justify-between`}>
            <div className="flex flex-col items-start gap-y-4 w-44 border-[0.5px] border-blue-600/40 p-3 rounded-[6px] relative bg-blue-500/30 hover:bg-blue-500/20">
            ...
            <div className="flex flex-col items-start gap-y-2 w-44 border-[0.5px] border-green-600/40 p-3 rounded-[6px] relative bg-green-500/30 hover:bg-green-500/20">
            ...
            <div className="flex flex-col items-start gap-y-2 w-44 border-[0.5px] border-red-600/40 p-3 rounded-[6px] relative bg-red-500/30 hover:bg-red-500/20">
            ...
            <div className="flex flex-col items-start gap-y-2 w-44 border-[0.5px] border-yellow-600/40 p-3 rounded-[6px] relative bg-yellow-500/30 hover:bg-yellow-500/20">
                <FcReadingEbook size={20} className="absolute top-3 right-3" />
                <span className="text-xs font-light text-neutral-100">Channel Count</span>
                <span className="text-xl font-medium text-yellow-500">{"16"}</span>
            </div>
        </div>
    )
}