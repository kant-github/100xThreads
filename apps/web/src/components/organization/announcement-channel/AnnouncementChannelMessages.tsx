    ...
    return (
        <div className="dark:bg-neutral-900 h-full flex flex-col items-start w-full p-6 relative">
            <div className="mr-4 absolute top-6 right-3">
                ...
                {createAnnoucementModal && <CreateAnnouncementForm createAnnoucementModal={createAnnoucementModal} setCreateAnnouncementModal={setCreateAnnouncementModal} className="z-50" />}
            </div>
