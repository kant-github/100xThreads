...
export default function () {
    ...
    return (
        <div className="bg-light dark:bg-neutral-900 h-full relative flex flex-col">
            ...
            <div className="bg-[#37474f] dark:bg-secDark my-8 mx-12 rounded-[8px] shadow-lg shadow-black/40 flex-grow overflow-hidden ">
                {loading ? (
