        ...
        <div className={`flex flex-col space-y-[4px] w-full relative ${className}`}>
            ...
            <div className="relative">
                <input
                    ...
                    className="px-4 py-[11px] text-xs font-medium border-[1px] border-zinc-400 dark:border-zinc-600 text-black shadow-sm focus:outline-none rounded-[6px] w-full pr-10 dark:bg-neutral-900 dark:text-gray-200 placeholder:text-[12px] placeholder:text-neutral-400"
                />{
                    type === "password" && (
